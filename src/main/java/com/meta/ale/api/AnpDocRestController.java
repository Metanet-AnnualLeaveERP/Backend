...
@Api(tags = {"연차 사용 요청서"},description = "연차사용 요청서에 대한 서비스")
public class AnpDocRestController {
    ...
    @ApiOperation(value = "연차사용요청서 전체 조회")
    ...
    @ApiOperation(value = "연차사용요청서 상세 조회")
